...
const Collaboration = ({ onBack }: CollaborationProps) => {
  ...
  const [sharedPlans] = useState<SharedPlan[]>([
    ...
    },
    {
      ...
      ownerAvatar: '👩‍💼',
      sharedWith: ['You', 'Mr. John Smith', 'Ms. Lisa Brown', 'Mr. Prakash Kumar'],
    ...
    },
    {
      ...
      ownerAvatar: '👨‍🔬',
      sharedWith: ['You', 'Prof. Vishnu Prasad'],
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <div style={{ display: 'grid', gap: '0.75rem' }}>
                {[
                  ...
                  { name: 'Prof. Vishnu Prasad', avatar: '👨‍🔬', department: 'Science' },
