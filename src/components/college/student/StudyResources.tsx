...
import { COLLEGE_RESOURCES } from '../../../data/college-resources';
...
const StudyResources = () => {
  ...
  // Use centralized resources data - map college resources to study resources format
  const resources: StudyResource[] = COLLEGE_RESOURCES.map(resource => ({
    id: resource.id,
    ...
    size: resource.duration || 'N/A'
  }));

  const subjects = ['all', 'Data Structures', 'Linear Algebra', 'Digital Electronics', 'Thermodynamics', 'DBMS', 'Operating Systems', 'Web Technologies'];
